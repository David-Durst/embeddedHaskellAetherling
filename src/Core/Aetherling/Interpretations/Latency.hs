...
get_node_latency (Partition_ssN _ _ _) = 1
get_node_latency (Unpartition_ssN _ _ _) = 1
get_node_latency (Partition_ttN no vo ni vi _) = vo + no*(ni + vi)
get_node_latency (Unpartition_ttN no vo ni vi _) = vo + no*(ni + vi)
get_node_latency (Partition_tsN no ni v _) = v + ni
get_node_latency (Unpartition_tsN no ni v _) = v + ni
