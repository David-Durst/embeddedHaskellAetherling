...
add_pipeline_registers' e@(Counter_tN _ _ _ _ _ _) maybe_num_end_registers = do
  add_pipeline_registers_if_last maybe_num_end_registers e
add_pipeline_registers' e@(Counter_tnN _ _ _ _ _ _) maybe_num_end_registers = do
  add_pipeline_registers_if_last maybe_num_end_registers e
add_pipeline_registers' e@(Counter_tsN _ _ _ _ _ _ _) maybe_num_end_registers = do
  add_pipeline_registers_if_last maybe_num_end_registers e
