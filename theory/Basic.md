...
1. `Serialize no ni vo vi :: TSeq no (vo+no*vi) (SSeq ni t) -> TSeq no vo (TSeq ni vi t)`
1. `SSeq_To_Tuple n :: SSeq n t -> NTuple n t`
1. `Deserialize no ni vo vi :: TSeq no vo (TSeq ni vi t) -> TSeq no (vo+no*vi) (SSeq ni t)`
