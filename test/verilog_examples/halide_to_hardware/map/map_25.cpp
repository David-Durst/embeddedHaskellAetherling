...
#pragma HLS INTERFACE ap_hs port=hw_output
 ...
 // dispatch_stream(_hw_input_stencil_stream, 2, 8, 8, 200, 1, 1, 1, 1, "hw_output", 1, 0, 200, 0, 1);
...
#pragma HLS RESOURCE variable=_hw_input_stencil_stream_to_hw_output core=FIFO_SRL
 ...
 for (int _dim_0 = 0; _dim_0 <= 192; _dim_0 += 8)
 {
#pragma HLS PIPELINE
  PackedStencil<uint8_t, 8, 1> _tmp_stencil = _hw_input_stencil_stream.read();
  if (_dim_0 >= 0 && _dim_0 <= 192 && _dim_1 >= 0 && _dim_1 <= 0)
  {
 ...
 {
  for (int _hw_output_x___scan_dim_0 = 0; _hw_output_x___scan_dim_0 < 0 + 25; _hw_output_x___scan_dim_0++)
  {
...
#pragma HLS ARRAY_PARTITION variable=_hw_output_stencil.value complete dim=0
   ...
   uint8_t _264 = _hw_input_stencil(4, 0);
   uint8_t _265 = (uint8_t)(5);
   uint8_t _266 = _264 + _265;
   _hw_output_stencil(4, 0) = _266;
   uint8_t _267 = _hw_input_stencil(5, 0);
   uint8_t _268 = (uint8_t)(5);
   uint8_t _269 = _267 + _268;
   _hw_output_stencil(5, 0) = _269;
   uint8_t _270 = _hw_input_stencil(6, 0);
   uint8_t _271 = (uint8_t)(5);
   uint8_t _272 = _270 + _271;
   _hw_output_stencil(6, 0) = _272;
   uint8_t _273 = _hw_input_stencil(7, 0);
   uint8_t _274 = (uint8_t)(5);
   uint8_t _275 = _273 + _274;
   _hw_output_stencil(7, 0) = _275;
   AxiPackedStencil<uint8_t, 8, 1> _hw_output_stencil_packed = _hw_output_stencil;
   if (_hw_output_x___scan_dim_0 == 24 && _hw_output_y___scan_dim_1 == 0) {
