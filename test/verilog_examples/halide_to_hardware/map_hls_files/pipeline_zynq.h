#ifndef HALIDE__pipeline_zynq_h
#define HALIDE__pipeline_zynq_h
#include <stdint.h>
...
int pipeline_zynq(struct halide_buffer_t *_p2___input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int pipeline_zynq_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *pipeline_zynq_metadata() HALIDE_FUNCTION_ATTRS;
int pipeline_zynq_old_buffer_t(struct buffer_t *_p2___input, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
