module Test_Big_Real_Math where
import Test.Tasty
...
row_size_conv2d_big_real :: Integer = 1920
col_size_conv2d_big_real :: Integer = 1080
img_size_conv2d_big_real :: Int = fromInteger $ col_size_conv2d_big_real*row_size_conv2d_big_real
big_real_conv_2d = conv_2d_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt8))
big_real_conv_2d_seq_idx = add_indexes $ seq_shallow_to_deep big_real_conv_2d
big_real_conv_2d_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_real_conv_2d_slowdowns = speed_to_slow [1] (toInteger img_size_conv2d_big_real)
big_real_conv_2d_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_real_conv_2d s) big_real_conv_2d_throughputs
big_real_conv_2d_ppar_typechecked =
  fmap check_type big_real_conv_2d_ppar
big_real_conv_2d_ppar_typechecked' =
  fmap check_type_get_error big_real_conv_2d_ppar
big_real_conv_2d_inputs :: [[Word8]] = map (map fromIntegral) [[i*5 | i <- [1..row_size_conv2d_big_real*col_size_conv2d_big_real]]]
big_real_conv_2d_output :: [Word8] =
  conv_generator $ stencil_generator row_size_conv2d_big_real (big_real_conv_2d_inputs !! 0)
big_real_conv_2d_results = sequence $
  fmap (\s -> test_with_backend
              big_real_conv_2d (wrap_single_t s)
              Magma (Save_Gen_Verilog "big_real_conv2d")
              big_real_conv_2d_inputs big_real_conv_2d_output) big_real_conv_2d_throughputs
big_real_conv_2d_results_chisel = sequence $
  fmap (\s -> test_with_backend
              big_real_conv_2d (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_real_conv2d")
              big_real_conv_2d_inputs big_real_conv_2d_output) big_real_conv_2d_throughputs
big_real_conv_2d_results' = sequence $
  fmap (\s -> test_with_backend
              big_real_conv_2d (wrap_single_t s)
              Magma No_Verilog
              big_real_conv_2d_inputs big_real_conv_2d_output) [big_real_conv_2d_throughputs !! 0]
big_real_conv_2d_results_chisel' = sequence $
  fmap (\s -> test_with_backend
              big_real_conv_2d (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_real_conv2d")
              big_real_conv_2d_inputs big_real_conv_2d_output) [big_real_conv_2d_throughputs !! 5]
big_real_conv_2d_st_prints = sequence $
  fmap (\s -> compile_to_file
              big_real_conv_2d (wrap_single_t s)
              text_backend "conv2d") big_real_conv_2d_throughputs
big_real_conv_2d_verilog_prints = sequence $
  fmap (\s -> compile_to_file
              big_real_conv_2d (wrap_single_t s)
              Magma "conv2d") big_real_conv_2d_throughputs

row_size_big_real_b2b = 1920
col_size_big_real_b2b = 1080
img_size_big_real_b2b :: Int = fromInteger $ col_size_big_real_b2b*row_size_big_real_b2b
big_real_conv_2d_b2b_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_real_conv_2d_b2b_slowdowns = speed_to_slow [1 % 3] (toInteger img_size_big_real_b2b)
big_real_conv_2d_b2b = conv_2d_b2b_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt8))
big_real_conv_2d_b2b_seq_idx = add_indexes $ seq_shallow_to_deep big_real_conv_2d_b2b
big_real_conv_2d_b2b_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_real_conv_2d_b2b s) big_real_conv_2d_b2b_throughputs
big_real_conv_2d_b2b_ppar_typechecked =
  fmap check_type big_real_conv_2d_b2b_ppar
big_real_conv_2d_b2b_ppar_typechecked' =
  fmap check_type_get_error big_real_conv_2d_b2b_ppar

big_real_conv_2d_b2b_inputs :: [[Word8]] = map (map fromIntegral) [[1..row_size_big_real_b2b*col_size_big_real_b2b]]
big_real_conv_2d_b2b_output :: [Word8] =
  conv_2x2_generator $ stencil_2x2_generator row_size_big_real_b2b $
  conv_generator $ stencil_generator row_size_big_real_b2b $ head big_real_conv_2d_b2b_inputs
big_real_conv_2d_b2b_results = sequence $
  fmap (\s -> test_with_backend
              big_real_conv_2d_b2b (wrap_single_t s)
              Magma (Save_Gen_Verilog "big_real_conv2d_b2b")
              big_real_conv_2d_b2b_inputs big_real_conv_2d_b2b_output) big_real_conv_2d_b2b_throughputs
big_real_conv_2d_b2b_results_chisel = sequence $
  fmap (\s -> test_with_backend
              big_real_conv_2d_b2b (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_real_conv2d_b2b")
              big_real_conv_2d_b2b_inputs big_real_conv_2d_b2b_output) big_real_conv_2d_b2b_throughputs
...
row_size_sharpen_big_real :: Integer = 1920
col_size_sharpen_big_real :: Integer = 1080
img_size_sharpen_big_real :: Int = fromInteger $ col_size_sharpen_big_real*row_size_sharpen_big_real
big_real_sharpen = sharpen_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt8))
big_real_sharpen_seq_idx = add_indexes $ seq_shallow_to_deep big_real_sharpen
big_real_sharpen_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_real_sharpen_slowdowns = speed_to_slow [1] (toInteger img_size_sharpen_big_real)
big_real_sharpen_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_real_sharpen s) big_real_sharpen_throughputs
big_real_sharpen_ppar_typechecked =
  fmap check_type big_real_sharpen_ppar
big_real_sharpen_ppar_typechecked' =
  fmap check_type_get_error big_real_sharpen_ppar
big_real_sharpen_inputs :: [[Word8]] = map (map fromIntegral) $ [[i * 5 | i <- [1..row_size_sharpen_big_real * col_size_sharpen_big_real]]]
big_real_sharpen_output :: [Word8] =
  zipWith sharpen_one_pixel' 
  (conv_generator $ stencil_generator row_size_sharpen_big_real (big_real_sharpen_inputs !! 0))
  (big_real_sharpen_inputs !! 0)
big_real_sharpen_results = sequence $
  fmap (\s -> test_with_backend 
              big_real_sharpen (wrap_single_t s)
              Magma (Save_Gen_Verilog "big_real_sharpen")
              big_real_sharpen_inputs big_real_sharpen_output) big_real_sharpen_throughputs
big_real_sharpen_results_chisel = sequence $
  fmap (\s -> test_with_backend 
              big_real_sharpen (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_real_sharpen")
              big_real_sharpen_inputs big_real_sharpen_output) big_real_sharpen_throughputs

big_real_tests = testGroup "Big_Real Tests"
  [
    ...
    (TS.all_success big_real_sharpen_results_chisel) @? "big_real sharpen chisel failed"
  ]
...
apps_big_8_real_io = sequence [
  save_seq_test_io_as_json "big_apps_8_real/conv2d" big_real_conv_2d_inputs big_real_conv_2d_output,
  save_seq_test_io_as_json "big_apps_8_real/conv2d_b2b" big_real_conv_2d_b2b_inputs big_real_conv_2d_b2b_output,
  save_seq_test_io_as_json "big_apps_8_real/sharpen" big_real_sharpen_inputs big_real_sharpen_output
  ]
