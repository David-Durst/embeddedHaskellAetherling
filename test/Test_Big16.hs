...
row_size_conv2d_big_16 :: Integer = 1920
col_size_conv2d_big_16 :: Integer = 1080
img_size_conv2d_big_16 :: Int = fromInteger $ col_size_conv2d_big_16*row_size_conv2d_big_16
big_16_conv_2d = conv_2d_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt16))
big_16_conv_2d_seq_idx = add_indexes $ seq_shallow_to_deep big_16_conv_2d
big_16_conv_2d_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_16_conv_2d_slowdowns = speed_to_slow [1] (toInteger img_size_conv2d_big_16)
big_16_conv_2d_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_16_conv_2d s) big_16_conv_2d_throughputs
big_16_conv_2d_ppar_typechecked =
  fmap check_type big_16_conv_2d_ppar
big_16_conv_2d_ppar_typechecked' =
  fmap check_type_get_error big_16_conv_2d_ppar
big_16_conv_2d_inputs :: [[Word16]] = map (map fromIntegral) [[i*5 | i <- [1..row_size_conv2d_big_16*col_size_conv2d_big_16]]]
big_16_conv_2d_output :: [Word16] =
  conv_generator $ stencil_generator row_size_conv2d_big_16 (big_16_conv_2d_inputs !! 0)
big_16_conv_2d_results = sequence $
  fmap (\s -> test_with_backend
              big_16_conv_2d (wrap_single_t s)
              Magma (Save_Gen_Verilog "big_16_conv2d")
              big_16_conv_2d_inputs big_16_conv_2d_output) big_16_conv_2d_throughputs
big_16_conv_2d_results_chisel = sequence $
  fmap (\s -> test_with_backend
              big_16_conv_2d (wrap_single_t s)
...
big_16_conv_2d_results_chisel' = sequence $
  fmap (\s -> test_with_backend
              big_16_conv_2d (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_16_conv2d")
              big_16_conv_2d_inputs big_16_conv_2d_output) [big_16_conv_2d_throughputs !! 5]
big_16_conv_2d_st_prints = sequence $
  fmap (\s -> compile_to_file
              big_16_conv_2d (wrap_single_t s)
              text_backend "conv2d") big_16_conv_2d_throughputs
big_16_conv_2d_verilog_prints = sequence $
  fmap (\s -> compile_to_file
              big_16_conv_2d (wrap_single_t s)
              Magma "conv2d") big_16_conv_2d_throughputs

row_size_big_16_b2b = 1920
col_size_big_16_b2b = 1080
img_size_big_16_b2b :: Int = fromInteger $ col_size_big_16_b2b*row_size_big_16_b2b
big_16_conv_2d_b2b_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_16_conv_2d_b2b_slowdowns = speed_to_slow [1 % 3] (toInteger img_size_big_16_b2b)
big_16_conv_2d_b2b = conv_2d_b2b_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt16))
big_16_conv_2d_b2b_seq_idx = add_indexes $ seq_shallow_to_deep big_16_conv_2d_b2b
big_16_conv_2d_b2b_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_16_conv_2d_b2b s) big_16_conv_2d_b2b_throughputs
big_16_conv_2d_b2b_ppar_typechecked =
  fmap check_type big_16_conv_2d_b2b_ppar
big_16_conv_2d_b2b_ppar_typechecked' =
  fmap check_type_get_error big_16_conv_2d_b2b_ppar

big_16_conv_2d_b2b_inputs :: [[Word16]] = map (map fromIntegral) [[1..row_size_big_16_b2b*col_size_big_16_b2b]]
big_16_conv_2d_b2b_output :: [Word16] =
  conv_2x2_generator $ stencil_2x2_generator row_size_big_16_b2b $
  conv_generator $ stencil_generator row_size_big_16_b2b $
  head big_16_conv_2d_b2b_inputs
big_16_conv_2d_b2b_results = sequence $
  fmap (\s -> test_with_backend
              big_16_conv_2d_b2b (wrap_single_t s)
              Magma (Save_Gen_Verilog "big_16_conv2d_b2b")
              big_16_conv_2d_b2b_inputs big_16_conv_2d_b2b_output) big_16_conv_2d_b2b_throughputs
big_16_conv_2d_b2b_results_chisel = sequence $
  fmap (\s -> test_with_backend
              big_16_conv_2d_b2b (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_16_conv2d_b2b")
              big_16_conv_2d_b2b_inputs big_16_conv_2d_b2b_output) big_16_conv_2d_b2b_throughputs
...
row_size_sharpen_big_16 :: Integer = 1920
col_size_sharpen_big_16 :: Integer = 1080
img_size_sharpen_big_16 :: Int = fromInteger $ col_size_sharpen_big_16*row_size_sharpen_big_16
big_16_sharpen = sharpen_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt16))
big_16_sharpen_seq_idx = add_indexes $ seq_shallow_to_deep big_16_sharpen
big_16_sharpen_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_16_sharpen_slowdowns = speed_to_slow [1] (toInteger img_size_sharpen_big_16)
big_16_sharpen_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_16_sharpen s) big_16_sharpen_throughputs
big_16_sharpen_ppar_typechecked =
  fmap check_type big_16_sharpen_ppar
big_16_sharpen_ppar_typechecked' =
  fmap check_type_get_error big_16_sharpen_ppar
big_16_sharpen_inputs :: [[Word16]] = map (map fromIntegral) [[i * 5 | i <- [1..row_size_sharpen_big_16 * col_size_sharpen_big_16]]]
big_16_sharpen_output :: [Word16] =
  zipWith sharpen_one_pixel' 
  (conv_generator $ stencil_generator row_size_sharpen_big_16 (big_16_sharpen_inputs !! 0))
  (big_16_sharpen_inputs !! 0)
big_16_sharpen_results = sequence $
  fmap (\s -> test_with_backend 
              big_16_sharpen (wrap_single_t s)
              Magma (Save_Gen_Verilog "big_16_sharpen")
              big_16_sharpen_inputs big_16_sharpen_output) big_16_sharpen_throughputs
big_16_sharpen_results_chisel = sequence $
  fmap (\s -> test_with_backend 
              big_16_sharpen (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_16_sharpen")
              big_16_sharpen_inputs big_16_sharpen_output) big_16_sharpen_throughputs

big_16_tests = testGroup "Big_16 Tests"
  [
    --testCase "single big_16 3x3 convolution magma" $
    --(TS.all_success big_16_conv_2d_results') @? "single 3x3 convolution failed"
    testCase "single big_16 3x3 convolution chisel" $
    (TS.all_success big_16_conv_2d_results_chisel) @? "single 3x3 convolution chisel failed",
    testCase "big_16 3x3 conv to 2x2 conv chisel" $
    (TS.all_success big_16_conv_2d_b2b_results_chisel) @? "big_16 3x3 conv to 2x2 conv chisel failed",
    testCase "big_16 sharpen chisel" $
    (TS.all_success big_16_sharpen_results_chisel) @? "big_16 sharpen chisel failed"
  ]
