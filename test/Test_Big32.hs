...
row_size_conv2d_big_32 :: Integer = 1920
col_size_conv2d_big_32 :: Integer = 1080
img_size_conv2d_big_32 :: Int = fromInteger $ col_size_conv2d_big_32*row_size_conv2d_big_32
big_32_conv_2d = conv_2d_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt32))
big_32_conv_2d_seq_idx = add_indexes $ seq_shallow_to_deep big_32_conv_2d
big_32_conv_2d_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_32_conv_2d_slowdowns = speed_to_slow [1] (toInteger img_size_conv2d_big_32)
big_32_conv_2d_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_32_conv_2d s) big_32_conv_2d_throughputs
...
big_32_conv_2d_results = sequence $
  fmap (\s -> test_with_backend
              ...
              Magma (Save_Gen_Verilog "big_32_conv2d")
              big_32_conv_2d_inputs big_32_conv_2d_output) big_32_conv_2d_throughputs
big_32_conv_2d_results_chisel = sequence $
  fmap (\s -> test_with_backend
              big_32_conv_2d (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_32_conv2d")
              big_32_conv_2d_inputs big_32_conv_2d_output) big_32_conv_2d_throughputs
big_32_conv_2d_results' = sequence $
  fmap (\s -> test_with_backend
              big_32_conv_2d (wrap_single_t s)
              Magma No_Verilog
              big_32_conv_2d_inputs big_32_conv_2d_output) [big_32_conv_2d_throughputs !! 0]
big_32_conv_2d_results_chisel' = sequence $
  fmap (\s -> test_with_backend
              big_32_conv_2d (wrap_single_t s)
              Chisel (Save_Gen_Verilog "big_32_conv2d")
              big_32_conv_2d_inputs big_32_conv_2d_output) [big_32_conv_2d_throughputs !! 4]
...
big_32_conv_2d_verilog_prints = sequence $
  fmap (\s -> compile_to_file
              big_32_conv_2d (wrap_single_t s)
              Magma "conv2d") big_32_conv_2d_throughputs

row_size_big_32_b2b = 1920
col_size_big_32_b2b = 1080
img_size_big_32_b2b :: Int = fromInteger $ col_size_big_32_b2b*row_size_big_32_b2b
big_32_conv_2d_b2b_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_32_conv_2d_b2b_slowdowns = speed_to_slow [1 % 3] (toInteger img_size_big_32_b2b)
big_32_conv_2d_b2b = conv_2d_b2b_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt32))
big_32_conv_2d_b2b_seq_idx = add_indexes $ seq_shallow_to_deep big_32_conv_2d_b2b
big_32_conv_2d_b2b_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_32_conv_2d_b2b s) big_32_conv_2d_b2b_throughputs
big_32_conv_2d_b2b_ppar_typechecked =
  fmap check_type big_32_conv_2d_b2b_ppar
big_32_conv_2d_b2b_ppar_typechecked' =
...
big_32_conv_2d_b2b_results = sequence $
  fmap (\s -> test_with_backend
              ...
              Magma (Save_Gen_Verilog "big_32_conv2d_b2b")
              big_32_conv_2d_b2b_inputs big_32_conv_2d_b2b_output) big_32_conv_2d_b2b_throughputs
big_32_conv_2d_b2b_results_chisel = sequence $
  fmap (\s -> test_with_backend
              big_32_conv_2d_b2b (wrap_single_t s)
...
row_size_sharpen_big_32 :: Integer = 1920
col_size_sharpen_big_32 :: Integer = 1080
img_size_sharpen_big_32 :: Int = fromInteger $ col_size_sharpen_big_32*row_size_sharpen_big_32
big_32_sharpen = sharpen_shallow_no_input (Proxy @1920) $ 
  com_input_seq "I" (Proxy :: Proxy (Seq 2073600 Atom_UInt32))
big_32_sharpen_seq_idx = add_indexes $ seq_shallow_to_deep big_32_sharpen
big_32_sharpen_throughputs = [16, 8, 4, 2, 1, 1 % 3]
--big_32_sharpen_slowdowns = speed_to_slow [1] (toInteger img_size_sharpen_big_32)
big_32_sharpen_ppar =
  fmap (\s -> compile_with_throughput_to_expr big_32_sharpen s) big_32_sharpen_throughputs
...
big_32_sharpen_results = sequence $
  fmap (\s -> test_with_backend 
              big_32_sharpen (wrap_single_t s)
              Magma (Save_Gen_Verilog "big_32_sharpen")
              big_32_sharpen_inputs big_32_sharpen_output) big_32_sharpen_throughputs
big_32_sharpen_results_chisel = sequence $
  fmap (\s -> test_with_backend 
              big_32_sharpen (wrap_single_t s)
...
big_32_tests = testGroup "Big_32 Tests"
  [
    --testCase "single big_32 3x3 convolution magma" $
    --(TS.all_success big_32_conv_2d_results') @? "single 3x3 convolution failed"
    ...
    testCase "big_32 3x3 conv to 2x2 conv chisel" $
