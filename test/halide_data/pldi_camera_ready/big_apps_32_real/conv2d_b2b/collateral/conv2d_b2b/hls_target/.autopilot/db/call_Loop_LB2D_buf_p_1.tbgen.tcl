set moduleName call_Loop_LB2D_buf_p_1
...
set C_modelName {call_Loop_LB2D_buf_p.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_stream_V_value_V int 32 regular {fifo 0 volatile }  }
	{ slice_stream_V_value_V int 64 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_V_value_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "slice_stream_V_value_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ slice_stream_V_value_V_din sc_out sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "slice_stream_V_value_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "slice_stream_V_value_V", "role": "din" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "2071917", "Max" : "2071917"}
]}
...
set Spec2ImplPortList { 
	...
	slice_stream_V_value_V { ap_fifo {  { slice_stream_V_value_V_din fifo_data 1 64 }  { slice_stream_V_value_V_full_n fifo_status 0 1 }  { slice_stream_V_value_V_write fifo_update 1 1 } } }
}
