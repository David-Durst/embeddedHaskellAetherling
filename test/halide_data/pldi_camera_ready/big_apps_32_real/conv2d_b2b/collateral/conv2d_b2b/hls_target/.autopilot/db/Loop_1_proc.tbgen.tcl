...
set C_modelArgList {
	...
	{ p_mul_stencil_update_stream_V_value_V int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_hw_input_stencil_stream_V_value_V", "interface" : "fifo", "bitwidth" : 288, "direction" : "READONLY"} , 
 	{ "Name" : "p_mul_stencil_update_stream_V_value_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ p_mul_stencil_update_stream_V_value_V_din sc_out sc_lv 32 signal 1 } 
	{ p_mul_stencil_update_stream_V_value_V_full_n sc_in sc_logic 1 signal 1 } 
	{ p_mul_stencil_update_stream_V_value_V_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_mul_stencil_update_stream_V_value_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_mul_stencil_update_stream_V_value_V", "role": "din" }} , 
 	{ "name": "p_mul_stencil_update_stream_V_value_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_mul_stencil_update_stream_V_value_V", "role": "full_n" }} , 
 	{ "name": "p_mul_stencil_update_stream_V_value_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_mul_stencil_update_stream_V_value_V", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "p_mul_stencil_update_stream_V_value_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	p_mul_stencil_update_stream_V_value_V { ap_fifo {  { p_mul_stencil_update_stream_V_value_V_din fifo_data 1 32 }  { p_mul_stencil_update_stream_V_value_V_full_n fifo_status 0 1 }  { p_mul_stencil_update_stream_V_value_V_write fifo_update 1 1 } } }
}
