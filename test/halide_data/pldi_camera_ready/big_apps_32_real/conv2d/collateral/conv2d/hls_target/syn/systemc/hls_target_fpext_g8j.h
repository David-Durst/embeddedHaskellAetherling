...
#ifndef __hls_target_fpext_g8j__HH__
#define __hls_target_fpext_g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_target_fpext_g8j) {
    ...
    SC_CTOR(hls_target_fpext_g8j):  ACMP_fpext_U ("ACMP_fpext_U") {
