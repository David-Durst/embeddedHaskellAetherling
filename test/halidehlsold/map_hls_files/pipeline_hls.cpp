...
int pipeline_hls(struct halide_buffer_t *_p2_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_45)
 {
  ...
  int32_t _195 = _12 + _13;
  int32_t _196 = _195 + -200;
  int32_t _197 = min(_12, _196);
  {
   int32_t _198 = max(_13, 200);
   int64_t _199 = _198;
   int64_t _200 = _199 * _16;
   if ((_200 > ((int64_t(1) << 31) - 1)) || ((_200 * sizeof(uint8_t )) > ((int64_t(1) << 31) - 1)))
   {
    halide_error(_ucon, "32-bit signed overflow computing size of allocation hw_input\n");
    return -1;
   } // overflow test hw_input
   int64_t _201 = _200;
   uint8_t *_hw_input = (uint8_t  *)halide_malloc(_ucon, sizeof(uint8_t )*_201);
   if (!_hw_input)
   {
   ...
   halide_buffer_t b1;
   struct halide_buffer_t *_202 = &b1;
   int32_t _203 = max(_13, 200);
   struct {
    const int32_t f_0;
    const int32_t f_1;
    const int32_t f_2;
   ...
   struct halide_dimension_t *_204 = (struct halide_dimension_t *)(&s2);
   uint64_t _205 = (uint64_t)(0);
   struct halide_device_interface_t *_206 = (struct halide_device_interface_t *)(_205);
   struct {
    const int32_t f_0;
    const int32_t f_1;
    const int32_t f_2;
   ...
   struct halide_dimension_t *_207 = (struct halide_dimension_t *)(&s3);
   struct halide_buffer_t *_208 = _halide_buffer_init(_202, _204, _hw_input, _205, _206, 1, 8, 2, _207, _205);
   struct halide_buffer_t * _hw_input_buffer = _208;
   // produce hw_input
   for (int _hw_input_s0_y = _15; _hw_input_s0_y < _15 + _16; _hw_input_s0_y++)
   {
    ...
    {
     int32_t _209 = _hw_input_s0_y * _27;
     int32_t _210 = _hw_input_s0_x + _209;
     int32_t _211 = _25 * _27;
     int32_t _212 = _22 + _211;
     int32_t _213 = _210 - _212;
     uint8_t _214 = ((const uint8_t *)_p2_input)[_213];
     int32_t _215 = _hw_input_s0_x - _197;
     int32_t _216 = _hw_input_s0_y - _15;
     int32_t _217 = max(_13, 200);
     int32_t _218 = _216 * _217;
     int32_t _219 = _215 + _218;
     _hw_input[_219] = _214;
    } // for _hw_input_s0_x
   } // for _hw_input_s0_y
   // consume hw_input
   {
    int32_t _220 = max(_13, 200);
    int64_t _221 = _220;
    int64_t _222 = _221 * _16;
    if ((_222 > ((int64_t(1) << 31) - 1)) || ((_222 * sizeof(uint8_t )) > ((int64_t(1) << 31) - 1)))
    {
     halide_error(_ucon, "32-bit signed overflow computing size of allocation hw_output\n");
     return -1;
    } // overflow test hw_output
    int64_t _223 = _222;
    uint8_t *_hw_output = (uint8_t  *)halide_malloc(_ucon, sizeof(uint8_t )*_223);
    if (!_hw_output)
    {
     return halide_error_out_of_memory(_ucon);
    }
    ...
    halide_buffer_t b2;
    struct halide_buffer_t *_224 = &b2;
    int32_t _225 = max(_13, 200);
    struct {
     const int32_t f_0;
     const int32_t f_1;
     const int32_t f_2;
    ...
    struct halide_dimension_t *_226 = (struct halide_dimension_t *)(&s4);
    uint64_t _227 = (uint64_t)(0);
    struct halide_device_interface_t *_228 = (struct halide_device_interface_t *)(_227);
    struct {
     const int32_t f_0;
     const int32_t f_1;
     const int32_t f_2;
    ...
    struct halide_dimension_t *_229 = (struct halide_dimension_t *)(&s5);
    struct halide_buffer_t *_230 = _halide_buffer_init(_224, _226, _hw_output, _227, _228, 1, 8, 2, _229, _227);
    struct halide_buffer_t * _hw_output_buffer = _230;
    // produce hw_output
    for (int _hw_output_s0_y_yo = 0; _hw_output_s0_y_yo < 0 + _16; _hw_output_s0_y_yo++)
    {
     int32_t _231 = _13 + 199;
     int32_t _232 = _231 / 200;
     int32_t _233 = _232 * 200;
     int32_t _234 = _231 - _233;
     int32_t _235 = _234 >> 31;
     int32_t _236 = 200 >> 31;
     int32_t _237 = _235 & _236;
     int32_t _238 = _232 - _237;
     int32_t _239 = ~_236;
     int32_t _240 = _235 & _239;
     int32_t _241 = _238 + _240;
     for (int _hw_output_s0_x_xo = 0; _hw_output_s0_x_xo < 0 + _241; _hw_output_s0_x_xo++)
     {
      int32_t _242 = _hw_output_s0_x_xo * 200;
      int32_t _243 = _242 + _12;
      int32_t _244 = _12 + _13;
      int32_t _245 = _244 + -200;
      int32_t _246 = min(_243, _245);
      hls::stream<AxiPackedStencil<uint8_t, 1, 1> > _hw_input_stencil_stream;
      int32_t _247 = _246 - _197;
      int32_t _248 = max(_13, 200);
      int32_t _249 = _hw_output_s0_y_yo * _248;
      int32_t _250 = _247 + _249;
      void *_251 = ((uint8_t *)_hw_input + _250);
      subimage_to_stream(_hw_input_buffer, _hw_input_stencil_stream, _251, 1, 200, _248, 1);
      (void)0;
      ...
      void *_255 = ((uint8_t *)_hw_output + _250);
      stream_to_subimage(_hw_output_buffer, _hw_output_stencil_stream, _255, 1, 200, _248, 1);
      (void)0;
    ...
    for (int _output_s0_y = _15; _output_s0_y < _15 + _16; _output_s0_y++)
    {
     ...
     {
      int32_t _256 = _output_s0_x - _197;
      int32_t _257 = _output_s0_y - _15;
      int32_t _258 = max(_13, 200);
      int32_t _259 = _257 * _258;
      int32_t _260 = _256 + _259;
      uint8_t _261 = _hw_output[_260];
      int32_t _262 = _output_s0_y * _17;
      int32_t _263 = _output_s0_x + _262;
      int32_t _264 = _15 * _17;
      int32_t _265 = _12 + _264;
      int32_t _266 = _263 - _265;
      ((uint8_t *)_output)[_266] = _261;
     } // for _output_s0_x
    } // for _output_s0_y
...
int pipeline_hls(struct buffer_t *_p2_input, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS {
 ...
 struct halide_dimension_t *_267 = (struct halide_dimension_t *)(&s6);
 struct halide_dimension_t * _t141 = _267;
 halide_buffer_t b3;
 struct halide_buffer_t *_268 = &b3;
 uint64_t _269 = (uint64_t)(0);
 void *_270 = (void *)(_269);
 struct halide_device_interface_t *_271 = (struct halide_device_interface_t *)(_269);
 struct halide_buffer_t *_272 = _halide_buffer_init(_268, _t141, _270, _269, _271, 1, 8, 2, _t141, _269);
 struct halide_buffer_t * _p2_input_upgraded = _272;
 struct {
  const int32_t f_0;
  const int32_t f_1;
  const int32_t f_2;
 ...
 struct halide_dimension_t *_273 = (struct halide_dimension_t *)(&s7);
 struct halide_dimension_t * _t145 = _273;
 halide_buffer_t b4;
 struct halide_buffer_t *_274 = &b4;
 struct halide_buffer_t *_275 = _halide_buffer_init(_274, _t145, _270, _269, _271, 1, 8, 2, _t145, _269);
 struct halide_buffer_t * _output_upgraded = _275;
 int32_t _276 = halide_upgrade_buffer_t(_ucon, "p2:input", _p2_input, _p2_input_upgraded);
 bool _277 = _276 == 0;
 if (!_277)  {
  return _276;
 }
 int32_t _278 = halide_upgrade_buffer_t(_ucon, "output", _output, _output_upgraded);
 bool _279 = _278 == 0;
 if (!_279)  {
  return _278;
 }
 int32_t _280 = pipeline_hls(_p2_input_upgraded, _output_upgraded);
 bool _281 = _280 == 0;
 if (!_281)  {
  return _280;
 }
 bool _282 = _halide_buffer_is_bounds_query(_p2_input_upgraded);
 if (_282)
 {
  int32_t _283 = halide_downgrade_buffer_t(_ucon, "p2:input", _p2_input_upgraded, _p2_input);
  bool _284 = _283 == 0;
  if (!_284)   {
   return _283;
  }
 ...
 {
  int32_t _285 = halide_downgrade_buffer_t_device_fields(_ucon, "p2:input", _p2_input_upgraded, _p2_input);
  bool _286 = _285 == 0;
  if (!_286)   {
   return _285;
  }
 } // if _282 else
 bool _287 = _halide_buffer_is_bounds_query(_output_upgraded);
 if (_287)
 {
  int32_t _288 = halide_downgrade_buffer_t(_ucon, "output", _output_upgraded, _output);
  bool _289 = _288 == 0;
  if (!_289)   {
   return _288;
  }
 ...
 {
  int32_t _290 = halide_downgrade_buffer_t_device_fields(_ucon, "output", _output_upgraded, _output);
  bool _291 = _290 == 0;
  if (!_291)   {
   return _290;
  }
