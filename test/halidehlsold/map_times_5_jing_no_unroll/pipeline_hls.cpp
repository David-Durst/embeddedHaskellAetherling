   ...
   // consume hw_input
   {
    ...
    for (int _hw_output_s0_y_yo = 0; _hw_output_s0_y_yo < 0 + _239; _hw_output_s0_y_yo++)
    {
     ...
     for (int _hw_output_s0_x_xo = 0; _hw_output_s0_x_xo < 0 + _246; _hw_output_s0_x_xo++)
     {
      ...
      void *_261 = ((uint8_t *)_hw_output + _256);
      stream_to_subimage(_hw_output_buffer, _hw_output_stencil_stream, _261, 1, 32, _254, 32);
      (void)0;
    ...
    for (int _output_s0_y = _15; _output_s0_y < _15 + _16; _output_s0_y++)
    {
     ...
     {
      int32_t _262 = _output_s0_x - _200;
      int32_t _263 = _output_s0_y - _197;
      int32_t _264 = max(_13, 32);
      int32_t _265 = _263 * _264;
      int32_t _266 = _262 + _265;
      uint8_t _267 = _hw_output[_266];
      int32_t _268 = _output_s0_y * _17;
      int32_t _269 = _output_s0_x + _268;
      int32_t _270 = _15 * _17;
      int32_t _271 = _12 + _270;
      int32_t _272 = _269 - _271;
      ((uint8_t *)_output)[_272] = _267;
     } // for _output_s0_x
    } // for _output_s0_y
...
int pipeline_hls(struct buffer_t *_p2_input, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS {
 ...
 struct halide_dimension_t *_273 = (struct halide_dimension_t *)(&s6);
 struct halide_dimension_t * _t165 = _273;
 halide_buffer_t b3;
 struct halide_buffer_t *_274 = &b3;
 uint64_t _275 = (uint64_t)(0);
 void *_276 = (void *)(_275);
 struct halide_device_interface_t *_277 = (struct halide_device_interface_t *)(_275);
 struct halide_buffer_t *_278 = _halide_buffer_init(_274, _t165, _276, _275, _277, 1, 8, 2, _t165, _275);
 struct halide_buffer_t * _p2_input_upgraded = _278;
 struct {
  const int32_t f_0;
  const int32_t f_1;
  const int32_t f_2;
 ...
 struct halide_dimension_t *_279 = (struct halide_dimension_t *)(&s7);
 struct halide_dimension_t * _t169 = _279;
 halide_buffer_t b4;
 struct halide_buffer_t *_280 = &b4;
 struct halide_buffer_t *_281 = _halide_buffer_init(_280, _t169, _276, _275, _277, 1, 8, 2, _t169, _275);
 struct halide_buffer_t * _output_upgraded = _281;
 int32_t _282 = halide_upgrade_buffer_t(_ucon, "p2:input", _p2_input, _p2_input_upgraded);
 bool _283 = _282 == 0;
 if (!_283)  {
  return _282;
 }
 int32_t _284 = halide_upgrade_buffer_t(_ucon, "output", _output, _output_upgraded);
 bool _285 = _284 == 0;
 if (!_285)  {
  return _284;
 }
 int32_t _286 = pipeline_hls(_p2_input_upgraded, _output_upgraded);
 bool _287 = _286 == 0;
 if (!_287)  {
  return _286;
 }
 bool _288 = _halide_buffer_is_bounds_query(_p2_input_upgraded);
 if (_288)
 {
  int32_t _289 = halide_downgrade_buffer_t(_ucon, "p2:input", _p2_input_upgraded, _p2_input);
  bool _290 = _289 == 0;
  if (!_290)   {
   return _289;
  }
 ...
 {
  int32_t _291 = halide_downgrade_buffer_t_device_fields(_ucon, "p2:input", _p2_input_upgraded, _p2_input);
  bool _292 = _291 == 0;
  if (!_292)   {
   return _291;
  }
 } // if _288 else
 bool _293 = _halide_buffer_is_bounds_query(_output_upgraded);
 if (_293)
 {
  int32_t _294 = halide_downgrade_buffer_t(_ucon, "output", _output_upgraded, _output);
  bool _295 = _294 == 0;
  if (!_295)   {
   return _294;
  }
 ...
 {
  int32_t _296 = halide_downgrade_buffer_t_device_fields(_ucon, "output", _output_upgraded, _output);
  bool _297 = _296 == 0;
  if (!_297)   {
   return _296;
  }
