...
def Module_0() -> DefineCircuitKind:
    class _Module_0(Circuit):
        ...
        def definition(cls):
            ...
            n6 = DefineMap2_T(4, 0, DefineAtomTupleCreator(ST_Int(8, True), ST_Int(8, True), has_valid=True))()
            wire(n4.O, n6.I0)
            wire(n5.O, n6.I1)
            wire(n4.valid_down & n5.valid_down, n6.valid_up)
            n12 = DefineMap_T(4, 0, DefineAdd_Atom(True))()
            wire(n6.O, n12.I)
            wire(n6.valid_down, n12.valid_up)
            n13 = DefineFIFO(ST_TSeq(4, 0, ST_Int(8, True)), 1, has_valid=True)()
            wire(n12.O, n13.I)
            wire(n12.valid_down, n13.valid_up)
            n14 = DefineFIFO(ST_TSeq(4, 0, ST_Int(8, True)), 1, has_valid=True)()
            wire(n13.O, n14.I)
            wire(n13.valid_down, n14.valid_up)
            n15 = DefineFIFO(ST_TSeq(4, 0, ST_Int(8, True)), 1, has_valid=True)()
            wire(n14.O, n15.I)
...
fault_helpers.compile(Main(), "v./home/durst/dev/embeddedHaskellAetherling//test/no_bench/magma_examples/diamond_map/diamond_map_1 % 1thr.py")