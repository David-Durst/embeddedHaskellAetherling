...
def Module_1() -> DefineCircuitKind:
    class _Module_1(Circuit):
        name = "top"
        IO = ['I', In(ST_SSeq(4, ST_SSeq(4, ST_Int(8, False))).magma_repr()),'O', Out(ST_SSeq(4, ST_SSeq(4, ST_Int(8, False))).magma_repr())] + ClockInterface(has_ce=False,has_reset=False) + valid_ports
        ...
        def definition(cls):
            ...
            n9 = DefineMap_S(4, Module_0(),True)()
            wire(n1.O, n9.I)
            wire(n1.valid_down, n9.valid_up)
            n10 = DefineFIFO(ST_SSeq(4, ST_SSeq(4, ST_Int(8, False))), 1, has_valid=True)()
            wire(n9.O, n10.I)
            wire(n9.valid_down, n10.valid_up)
            n11 = DefineFIFO(ST_SSeq(4, ST_SSeq(4, ST_Int(8, False))), 1, has_valid=True)()
            wire(n10.O, n11.I)
            wire(n10.valid_down, n11.valid_up)
            n12 = DefineFIFO(ST_SSeq(4, ST_SSeq(4, ST_Int(8, False))), 1, has_valid=True)()
            wire(n11.O, n12.I)
...
fault_helpers.compile(Main(), "v./home/durst/dev/embeddedHaskellAetherling//test/no_bench/magma_examples/seq_and_stuple/seq_and_stuple_16 % 1thr.py")