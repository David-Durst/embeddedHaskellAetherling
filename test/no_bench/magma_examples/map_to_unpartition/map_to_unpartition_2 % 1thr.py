...
def Module_0() -> DefineCircuitKind:
    class _Module_0(Circuit):
        ...
        def definition(cls):
            ...
            n7 = DefineReshape_ST(ST_TSeq(2, 0, ST_SSeq(2, ST_Int(8, True))), ST_TSeq(2, 0, ST_SSeq(2, ST_Int(8, True))), has_valid=True)()
            wire(n6.O, n7.I)
            wire(n6.valid_down, n7.valid_up)
            n12 = DefineMap_T(2, 0, DefineMap_S(2, DefineAbs_Atom(True),True))()
            wire(n7.O, n12.I)
            wire(n7.valid_down, n12.valid_up)
            n13 = DefineFIFO(ST_TSeq(2, 0, ST_SSeq(2, ST_Int(8, True))), 1, has_valid=True)()
            wire(n12.O, n13.I)
            wire(n12.valid_down, n13.valid_up)
            n14 = DefineFIFO(ST_TSeq(2, 0, ST_SSeq(2, ST_Int(8, True))), 1, has_valid=True)()
            wire(n13.O, n14.I)
            wire(n13.valid_down, n14.valid_up)
            n15 = DefineFIFO(ST_TSeq(2, 0, ST_SSeq(2, ST_Int(8, True))), 1, has_valid=True)()
            wire(n14.O, n15.I)
...
fault_helpers.compile(Main(), "v./home/durst/dev/embeddedHaskellAetherling//test/no_bench/magma_examples/map_to_unpartition/map_to_unpartition_2 % 1thr.py")