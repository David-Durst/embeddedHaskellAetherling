...
def Module_0() -> DefineCircuitKind:
    class _Module_0(Circuit):
        ...
        def definition(cls):
            ...
            n6 = DefineFIFO(ST_SSeq(4, ST_Int(8, True)), 1, has_valid=True)()
            wire(n5.O, n6.I)
            wire(n5.valid_down, n6.valid_up)
            n7 = DefineFIFO(ST_SSeq(4, ST_Int(8, True)), 1, has_valid=True)()
            wire(n6.O, n7.I)
...
fault_helpers.compile(Main(), "v./home/durst/dev/embeddedHaskellAetherling//test/no_bench/magma_examples/single_map_underutil/single_map_underutil_4 % 1thr.py")