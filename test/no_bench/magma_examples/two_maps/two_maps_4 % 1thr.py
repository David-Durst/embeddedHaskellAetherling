...
def Module_0() -> DefineCircuitKind:
    class _Module_0(Circuit):
        ...
        def definition(cls):
            ...
            n7 = DefineMap_S(4, DefineAbs_Atom(True),True)()
            wire(n4.O, n7.I)
            wire(n4.valid_down, n7.valid_up)
            n8 = DefineFIFO(ST_SSeq(4, ST_Int(8, True)), 1, has_valid=True)()
            wire(n7.O, n8.I)
            wire(n7.valid_down, n8.valid_up)
            n9 = DefineFIFO(ST_SSeq(4, ST_Int(8, True)), 1, has_valid=True)()
            wire(n8.O, n9.I)
            wire(n8.valid_down, n9.valid_up)
            n10 = DefineFIFO(ST_SSeq(4, ST_Int(8, True)), 1, has_valid=True)()
            wire(n9.O, n10.I)
...
fault_helpers.compile(Main(), "v./home/durst/dev/embeddedHaskellAetherling//test/no_bench/magma_examples/two_maps/two_maps_4 % 1thr.py")