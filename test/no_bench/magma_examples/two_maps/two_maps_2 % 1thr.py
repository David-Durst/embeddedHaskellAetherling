...
def Module_0() -> DefineCircuitKind:
    class _Module_0(Circuit):
        ...
        def definition(cls):
            ...
            n11 = DefineMap_T(2, 0, DefineMap_S(2, DefineAbs_Atom(True),True))()
            wire(n6.O, n11.I)
            wire(n6.valid_down, n11.valid_up)
            n12 = DefineFIFO(ST_TSeq(2, 0, ST_SSeq(2, ST_Int(8, True))), 1, has_valid=True)()
            wire(n11.O, n12.I)
...
fault_helpers.compile(Main(), "v./home/durst/dev/embeddedHaskellAetherling//test/no_bench/magma_examples/two_maps/two_maps_2 % 1thr.py")