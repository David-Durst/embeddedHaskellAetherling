...
def Module_1() -> DefineCircuitKind:
    class _Module_1(Circuit):
        ...
        @classmethod
        def definition(cls):
            n1 = DefineFIFO(ST_TSeq(4, 0, ST_Int(8, False)), 1, has_valid=True)()
            wire(cls.I, n1.I)
            wire(cls.valid_up, n1.valid_up)
            n13 = DefineMap_T(4, 0, Module_0())()
            wire(n1.O, n13.I)
            wire(n1.valid_down, n13.valid_up)
            n14 = DefineFIFO(ST_TSeq(4, 0, ST_Int(8, False)), 1, has_valid=True)()
            wire(n13.O, n14.I)
            wire(n13.valid_down, n14.valid_up)
            n15 = DefineFIFO(ST_TSeq(4, 0, ST_Int(8, False)), 1, has_valid=True)()
            wire(n14.O, n15.I)
            wire(n14.valid_down, n15.valid_up)
            n16 = DefineFIFO(ST_TSeq(4, 0, ST_Int(8, False)), 1, has_valid=True)()
            wire(n15.O, n16.I)
...
fault_helpers.compile(Main(), "v./home/durst/dev/embeddedHaskellAetherling//test/no_bench/magma_examples/map_to_up/map_to_up_1 % 1thr.py")